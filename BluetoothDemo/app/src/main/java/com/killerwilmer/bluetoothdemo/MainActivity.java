package com.killerwilmer.bluetoothdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    ListView pairedDivicesListView;
    ...
    public void viewPairedDevices(View view) {
        ...
        pairedDivicesListView.setAdapter(arrayAdapter);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pairedDivicesListView = (ListView) findViewById(R.id.pairedDivicesListView);
